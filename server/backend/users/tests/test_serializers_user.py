...
class TestUserSerializers:
    ...
    def test_user_serializer(self):
        user = User.objects.create_user(username='testuser', password=config("TEST_PASSWORD"), role='student', email='testuser@example.com', bio='This is a test bio.')
    ...
    def test_instructor_serializer(self):
        user = User.objects.create_user(username='instructor1', password=config("TEST_PASSWORD"), role='instructor', email='instructor1@example.com')
