...
from .views import CategoryViewSet, QuizAPIView, SubmitQuizAPIView, AddQuizView, AddQuestionView, DeleteQuizView, UpdateQuizView, QuizAttemptsView, UpdateQuestionView, deleteQuestionView
...
urlpatterns = [
    ...
    path('update-questions/<int:question_id>/', UpdateQuestionView.as_view(), name='update-question'),
    path('delete-question/<int:question_id>/', deleteQuestionView.as_view(), name='delete-question'),
]