...
const VideoContent = ({ url }) => {
	...
	return youtubeId ? (
	  <div className="w-full mb-6 flex flex-col items-center">
		<iframe
		  className="w-full md:w-3/4 h-52 md:h-80 rounded-lg"
  ...
  const PDFContent = ({ pdfUrl }) => (
	<div className="w-full flex flex-col items-center">
	  <iframe
		className="w-full md:w-11/12 h-96 md:h-[600px] rounded-xl shadow"
		src={pdfUrl}
		title="PDF Viewer"
	  />
	  <div className="mt-4">
...
const CourseContent = () => {
	...
	return (
		...
		<div className="bg-gray-50 px-4 md:px-20 py-6">
			{/* Top Controls */}
		...
		<div className="flex flex-col md:flex-row w-full gap-6 p-4 md:p-6">
			...
			<div className="md:w-3/4 w-full bg-white rounded-xl shadow-md p-4 md:p-6 space-y-4">
			<div className="text-gray-800 font-semibold text-2xl md:text-3xl mb-6">
			...
			<h3 className="text-lg md:text-xl font-bold text-gray-700 mb-4">All Contents</h3>
